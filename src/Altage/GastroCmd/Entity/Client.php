...
// Pour associer le champ siteId avec 
  ...
  /**
     ...
     * Add user
     *
     * @param \Altage\UserBundle\Entity\User $user
     * @return Client
     */
    public function addUser(\Altage\UserBundle\Entity\User $user)
    {
        $this->user[] = $user;
     ...
     * @param \Altage\UserBundle\Entity\User $user
     */
    public function removeUser(\Altage\UserBundle\Entity\User $user)
    {
